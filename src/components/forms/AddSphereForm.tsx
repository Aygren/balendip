...
interface AddSphereFormProps {
    isOpen: boolean
    onClose: () => void
    onSubmit: (sphere: Omit<LifeSphere, 'id' | 'user_id' | 'created_at' | 'updated_at'>) => void
}
...
export default function AddSphereForm({
    isOpen,
    onClose,
    onSubmit,
}: AddSphereFormProps) {
                    ...
                    <div className="grid grid-cols-5 gap-2 max-h-32 overflow-y-auto">
                        {defaultIcons.map((icon) => (
                            <button
                                ...
                                className={`w-10 h-10 rounded-lg border-2 text-lg transition-all flex items-center justify-center ${
                                    formData.icon === icon
